...
function App() {
  return (
   <React.Fragment>
     ...
     />
      <Header/>
        <div id="Project" style={{textAlign:"center"}}><h1 style={{fontSize:"60px"}}>My <span style={{color:"#03aad7"}}>Projects</span></h1></div>
        <div className="row">
            ...
            <Project projectName = "Online Store"
            ...
            <Project projectName = "Pet Clinic"
